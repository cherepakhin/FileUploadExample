### Пример загрузки файла из браузера в папку на сервере и, затем, получения этого файла.
...
Каталог для сохранения файлов, __относительно домашнего каталога пользователя__, задан как константа в application.yml:
